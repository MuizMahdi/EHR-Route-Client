...
export class NodeNetworkService implements OnInit
{
   ...
   private userNetworkUrl:string = AppConfig.apiUrl + '/users/current/networks';
   private networkRootUrl:string = AppConfig.apiUrl + '/network/merkle-root';
   private createNetworkUrl:string = AppConfig.apiUrl + '/network/create';
   private networkInviteUrl:string = AppConfig.apiUrl + '/network/invite';
   private networkInvitationAcceptUrl:string = AppConfig.apiUrl + '/network/invitation-accept';
   private searchNetworksByNameUrl:string = AppConfig.apiUrl + '/network/search-by-name';
   private getNetworkUuidByNameUrl:string = AppConfig.apiUrl + '/network/uuid';
   private networkDetailsUrl:string = AppConfig.apiUrl + '/network/details';
